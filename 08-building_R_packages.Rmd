...
4. Finnaly click **Create repository**. 
...
3. T o commit you package to GitHub, first make sure you have git installed locally then link your R Studio project to your zGitHub repository using the following commands in the terminal. 
