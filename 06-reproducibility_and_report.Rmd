...
Find [here]() more resources on R markdown. **________remember the resources_______**

2. **Setting a Seed fr Consistency:** R’s random number generator can be controlled with `set.seed()`. For instance;
```{r}
set.seed(42)
sample(1:100, 5)
```
...
- Start with an introduction: “This report explores the relationship between…”

**_______Add a screenshot______________**
